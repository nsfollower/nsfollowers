...
class Ns_Followers:
    def __init__(self):
        ...
        self.__username='unknown577229' #Enter UserName Here
        self._session='66972025907:cpvghxLhA2lOzJ:26:AYfKZDT-a_Q9iEEJJKKpRSR37gj2NS4L__nS0Y1xpw' #Enter SessionID Here
